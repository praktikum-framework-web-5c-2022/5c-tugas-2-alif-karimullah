...
class MatakuliahController extends Controller
{
    public function insert(){
        ...
        // RAW
        $sql = DB::insert("INSERT INTO matakuliahs (kode_mk,nama_mk,created_at,updated_at) VALUES ('STP001', 'Statistika Probabilitas',now(),now())");
        dump($sql);
    ...
    public function update(){
        ...
        //RAW
        $sql = DB::update("UPDATE matakuliahs SET nama_mk='Statistika Probabilitas',updated_at=now() WHERE id=?",[1]);
        dump($sql);
