...
class MahasiswaController extends Controller
{
    public function insert(){
        ...
        // RAW
        $sql = DB::insert("INSERT INTO mahasiswas (npm,nama,jenis_kelamin,alamat,tempat_lahir,tanggal_lahir,photo,created_at,updated_at) VALUES ('2010631170080', 'Alfachino Maulana','Pria','Jl.Cemara','Bekasi','2002-06-17','alfa.png',now(),now())");
        dump($sql);
